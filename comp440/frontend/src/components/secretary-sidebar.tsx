...
const navItems = [
  { href: "/secretary/classrooms", label: "Classrooms" },
  { href: "/secretary/search", label: "Search" },
  { href: "/secretary/conflict-logs", label: "Conflict Logs" },
  { href: "/secretary/blackout-hours", label: "Blackout Hours" },
  { href: "/secretary/requests", label: "Requests" },
];
        ...
        <div className="mt-auto">
          <div className="flex items-center gap-3 p-2">
            ...
            <div className="flex flex-col text-sm">
              <p className="font-semibold text-white">Secretary User</p>
